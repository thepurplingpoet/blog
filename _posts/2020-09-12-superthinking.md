...
Whenever faced with a dilemma regarding choices, matrix-models can be quite helpful.  As in a mathematical matrix, we create a box-like structure and evaluate our choices based on the options. For example, this Eisenhower Decision Matrix:
![Eisenhower Decision Matrix](Eisenhower-Decision.png)

The Consequence-Conviction Matrix:
![Consequence Conviction Matrix](Consequence-Conviction.png)

Radical Candor Matrix for offering feedback:
![Radical Candor](Radical-Candor.png)
Similary, we could have a Pro-Con or Cost-Benefit matrix for various options. 
